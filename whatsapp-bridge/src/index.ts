...
import { start, getStatus, getQr, sendMessage, saveWebhookConfig, onMessage } from './whatsapp.js'
...
app.get('/qr', (_req, res) => {
  ...
  res.send(`<html><body style="background:#0D0F12;color:#E8ECF0;display:flex;align-items:center;justify-content:center;height:100vh;font-family:sans-serif"><div style="text-align:center"><h2>⏳ Conectando...</h2><p style="color:#7A8599">Aguardando QR code...</p></div></body></html>`)
})
